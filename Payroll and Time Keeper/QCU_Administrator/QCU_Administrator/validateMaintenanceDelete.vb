...
Public Class validateMaintenanceDelete
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            Else
                If dr.Read Then
                    frmMaintenanceLeave.lblValidate.Text = dr("Password")
                    Me.Hide()
                Else
        ...
        End Try
    End Sub
    Private Sub validateMaintenanceDelete_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtPassword.Text = ""
    End Sub
End Class